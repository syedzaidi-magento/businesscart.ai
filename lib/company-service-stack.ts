...
interface CompanyServiceStackProps extends cdk.StackProps {
...
export class CompanyServiceStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: CompanyServiceStackProps) {
    ...
    const companyServiceLambda = new lambda.Function(this, 'CompanyServiceLambda', {
      ...
      code: lambda.Code.fromAsset(path.join(__dirname, '../../company-service-lambda/dist')),
      environment: {
    ...
    // API Gateway Routes
    const companies = props.api.root.addResource('companies');
    const companyId = companies.addResource('{id}');
    const customers = companyId.addResource('customers');
    const customer = companies.addResource('customer');
    ...
    companies.addMethod('GET', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
      requestParameters: {
        'method.request.header.X-Internal-Request': false,
      },
    });
    companies.addMethod('POST', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    companyId.addMethod('GET', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    companyId.addMethod('PUT', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    companyId.addMethod('DELETE', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    customers.addMethod('POST', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    customerId.addMethod('GET', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    code.addMethod('POST', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    codeValue.addMethod('GET', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
    codeCustomers.addMethod('POST', companyIntegration, {
      authorizer: props.authorizer,
      authorizationType: apigateway.AuthorizationType.CUSTOM,
    });
